  ...
  return (
    <div className="min-h-screen pt-20 pb-12 px-4">
      <div className="max-w-md mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold mb-8 text-center">Sign In</h1>
        
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <p className="text-center text-gray-600 mb-6">
            Sign in with your Google account to create events, add payments, and track your balances.
          </p>
          ...
          <div className="text-center text-sm text-gray-500 mt-4">
            No account creation needed. Just sign in with Google and start using NSplit.
          </div>
        </div>
      </div>
    </div>
